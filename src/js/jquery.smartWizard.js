...
(function ($, window, document, undefined) {
  ...
  var defaults = {
    ...
    toolbarSettings: {
      ...
      // Decide wether hide or disabling the button
      stateWhenUnsuitable: 'hide',
  ...
  function () {
    ...
    _createClass(SmartWizard, [{
      ...
      value: function _createToolbar(position) {
        ...
        var btnSubmit = this.options.toolbarSettings.showSubmitButton !== false ? $('<button></button>').text(this.options.lang.submit).addClass('btn sw-btn-submit') : null;
